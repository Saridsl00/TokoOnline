...
Route::middleware('is.customer')->group(function () {
    ...
    Route::put('/customer/updateakun/{id}', [CustomerController::class, 'updateAkun'])->name('customer.akun.update');
...
Route::get('/list-ongkir', function () {
    $response = Http::withHeaders([
        'key' => '3VlZqv9786c0c360b6109f3fFF1qNBN9'
    ])->get('https://rajaongkir.komerce.id/api/v1/destination/domestic-destination?search=sinduharjo&limit=5&offset=0'); //ganti 'province' atau 'city' 
    dd($response->json());
});
